...
data class LoginState(val mode: AuthMode = AuthMode.LOGIN, val identifier: String = "", val username: String = "", val password: String = "", val submit: AuthSubmitState = AuthSubmitState.Idle)
